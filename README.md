...
Ниже приведена таблица с наименьшим e-value для каждой пары протеном-гистон/белок, а также эта же таблица, но с -log_10 (e-value).

<img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/table_Eval.png" width="800" height="250"> <img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/table_logEval.png" width="900" height="250">
