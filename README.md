...
|:-------:|:----------------------:|:---------------:|
|H2A|<img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/H2A_alignment.png" width="400" height="200">|<div style="width:100px">По сравнению с другими гистонами, различий больше всего. Однако можно заметить, что они в основном заключаются в синонимичных заменах и полиморфизмах. Белки определённо выполняют схожие функции, но всё-таки не являются копиями друг друга. Возможно, различия являются следствием мутаций.</div>|
|H2B|<img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/H2B_alignment.png" width="400" height="200">|<div style="width:100px">В отличие от H2A, у этого гистона заметно больше консервативных участков. Белки очень схожи, поэтому для дальнейшего анализа можно выбрать любой из них.</div>|
|H3|<img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/H3_alignment.png" width="300" height="100">|<div style="width:100px"></div>|
|H4|<img src="https://github.com/KirillMatirko/hse23_project/blob/main/pics/H4_alignment.png" width="300" height="100">|<div style="width:100px"></div>|
